// DIVIDA DECLARADA, morre na F4 Tarefa 5 (BER-77).
//
// A F3 trocou esta tela por um <Redirect href="/" />, com a justificativa de
// que a rota so existia pra nao quebrar link antigo. Era falso: o
// register-reading navega pra ca em duas linhas, e o caminho mais comum do app
// (registrar leitura SEM fechar capitulo) perdeu a confirmacao inteira — o
// usuario caia na Home em silencio. A tela antiga voltou inteira, com o visual
