...
//
// Durante a transição, as duas convivem: o cliente do banco prefere a nova, e as
// travas de chamada interna aceitam qualquer uma. O caminho legado sai quando as
// chaves legadas forem desativadas no painel (ver BER-76).
